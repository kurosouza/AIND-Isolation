...
def custom_score_2(game, player):
    ...
    player_lmoves = game.get_legal_moves(player)
    opponent_lmoves = game.get_legal_moves(game.get_opponent(player))

    return float(len(game.get_legal_moves(player))) - float(len(opponent_lmoves))
...
def custom_score_3(game, player):
    ...
    return float(len(game.get_legal_moves(player))) - 2 * float(len(opponent_lmoves))
